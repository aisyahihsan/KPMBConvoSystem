...
if ((isset($_GET['referenceid'])) && ($_GET['referenceid'] != "")) {
  $deleteSQL = sprintf("DELETE FROM receipt WHERE referenceid=%s",
                       GetSQLValueString($_GET['referenceid'], "text"));

  mysql_select_db($database_convo, $convo);
  $Result1 = mysql_query($deleteSQL, $convo) or die(mysql_error());

  $deleteGoTo = "maintainreceipt.php";
...
<form id="form1" name="form1" method="get" action="deletereceipt.php">
  <table width="328" border="0" align="center">
    ...
    <tr>
      ...
      <td width="410" bgcolor="#FFCC66"><label for="idnumber"></label>
