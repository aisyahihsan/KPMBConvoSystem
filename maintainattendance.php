...
if (isset($_GET['idnumber'])) {
  $colname_Recordset1 = $_GET['idnumber'];
}
mysql_select_db($database_convo, $convo);
$query_Recordset1 = sprintf("SELECT * FROM attendance WHERE idnumber = %s", GetSQLValueString($colname_Recordset1, "text"));
 	  ...
 	  <table width="352" border="0" align="center">
 	    ...
 	    <tr>
 	      <td height="58" align="center" valign="middle" bgcolor="#FFCC66"><blockquote>
 	        <blockquote>
 	          <p>MAINTAIN ATTENDANCE</p>
 	          <p>INFORMATION              </p>
 	        </blockquote>
 	      </blockquote></td>
        </tr>
 	    <tr>
 	      <td align="center" valign="middle" bgcolor="#FFCC66"><a href="editattendanceinfo.php">Edit  Attendance Information </a></td>
        </tr>
 	    <tr>
