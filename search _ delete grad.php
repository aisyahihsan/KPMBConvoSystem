...
<form action="search &amp; delete grad2.php" method="get" name="form1" id="form1">
  <table width="590" border="0" align="center">
    <tr>
      ...
      <input name="idnumber" type="text" id="idnumber" value="<?php echo $row_display['idnumber']; ?>" readonly="readonly" /></td>
    </tr>
    <tr>
      <td bgcolor="#FFCC66"><label>Password:</label></td>
      <td bgcolor="#FFCC66"><input name="password" type="text" id="password" value="<?php echo $row_display['password']; ?>" readonly="readonly" /></td>
    </tr>
    <tr>
      <td bgcolor="#FFCC66">Name:</td>
      <td bgcolor="#FFCC66"><input name="studname" type="text" id="studname" value="<?php echo $row_display['studname']; ?>" readonly="readonly" /></td>
    </tr>
    <tr>
      <td bgcolor="#FFCC66"><label>IC Number:</label></td>
      <td bgcolor="#FFCC66"><input name="icnumber" type="text" id="icnumber" value="<?php echo $row_display['icnumber']; ?>" readonly="readonly" /></td>
    </tr>
    <tr>
      <td bgcolor="#FFCC66"><label>Address :</label></td>
      <td bgcolor="#FFCC66"><textarea name="studaddress" readonly="readonly" id="studaddress"><?php echo $row_display['studaddress']; ?></textarea></td>
    </tr>
    <tr>
      <td bgcolor="#FFCC66"><label>Tel Number:</label></td>
      <td bgcolor="#FFCC66"><input name="studtelno" type="text" id="studtelno" value="<?php echo $row_display['studtelno']; ?>" readonly="readonly" /></td>
    </tr>
    <tr>
      <td bgcolor="#FFCC66">Course:</td>
      <td bgcolor="#FFCC66"><input name="course" type="text" id="course" value="<?php echo $row_display['course']; ?>" readonly="readonly" /></td>
    </tr>
    <tr>
      <td bgcolor="#FFCC66">Year Intake: </td>
      <td bgcolor="#FFCC66"><p>
        <input name="yearintake" type="text" id="yearintake" value="<?php echo $row_display['yearintake']; ?>" readonly="readonly" />
        <br />
      </p></td>
    </tr>
    <tr>
